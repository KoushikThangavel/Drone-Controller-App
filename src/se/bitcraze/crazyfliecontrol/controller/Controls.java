...
import static se.bitcraze.crazyfliecontrol.controller.AbstractController.MAX_THRUST;
...
public class Controls {
   ...
   // private float mRollTrim = 0f;
  //  private float mPitchTrim = 0f;
    ...
    public void setDefaultPreferenceValues(Resources res) {
        ...
        mTrimDefaultValue = res.getString(R.string.preferences_trim_defaultValue_roll);
...
//    public void setTrim(float rollTrim) {
...
//    }
    ...
    public float getRollTrim() {
        Log.d("ROLL_TRIM","this is the roll trim "+mRollTrim);
        return mRollTrim;
    }
...
//    }
    ...
    public float getThrustFactor() {
        // ✅ Return half of MAX_THRUST to allow symmetric thrust [-MAX/2, +MAX/2]
        return MAX_THRUST / 2.0f;
    }
}
